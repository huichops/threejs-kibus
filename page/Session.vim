...
set laststatus=2
set ruler
set runtimepath=~/vimfiles,~\\vimfiles\\bundle\\nerdcommenter,~\\vimfiles\\bundle\\nerdtree,~\\vimfiles\\bundle\\tcomment_vim,~\\vimfiles\\bundle\\vim-easymotion,~\\vimfiles\\bundle\\vim-ruby,~\\vimfiles\\bundle\\vim-slim,~\\vimfiles\\bundle\\vim-surround,C:\\Program\ Files\ (x86)\\Vim/vimfiles,C:\\Program\ Files\ (x86)\\Vim\\vim74,C:\\Program\ Files\ (x86)\\Vim/vimfiles/after,~/vimfiles/after
set scrolloff=3
set shiftwidth=2
set showmatch
set smartcase
...
silent only
cd ~\Documents\boilerplate
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +170 index.html
badd +28 \Users\largumed\Documents\boilerplate\js\Tile.js
badd +36 \Users\largumed\Documents\boilerplate\js\AStar.js
badd +27 js\Map.js
args index.html
edit index.html
...
silent! normal! zE
let s:l = 170 - ((31 * winheight(0) + 28) / 56)
...
wincmd w
argglobal
edit \Users\largumed\Documents\boilerplate\js\Tile.js
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
exe 'vert 2resize ' . ((&columns * 86 + 117) / 235)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 73 - ((52 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
73
...
wincmd w
argglobal
edit \Users\largumed\Documents\boilerplate\js\AStar.js
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal balloonexpr=
